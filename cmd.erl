...
run() -> 
os:cmd("java -jar ~/Downloads/checkstyle-5.7/checkstyle-5.7-all.jar -c ~/Downloads/checkstyle-5.7/sun_checks.xml -r ~/Developer/workspace/oopinlupp2/src/*.java -o test.xml -f xml"),
